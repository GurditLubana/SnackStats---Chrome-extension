...
![SnackStats Logo](Images/logo128.png)
...
## Copyright Notice
© 2024 Gurdit Singh. All rights reserved. 

This project is open source and the source code is now publicly available. However, the project is still copyrighted to the author. You are free to use, modify, and distribute the code as long as you retain the original copyright notice in all copies or substantial portions of the software.

Unauthorized copying, distribution, or modification of the project without proper attribution is strictly prohibited. If you have any questions about usage or licensing, please contact.